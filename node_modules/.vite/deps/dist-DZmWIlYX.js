...
import { t as require_react_dom } from "./react-dom-BOmCuuDs.js";
import { t as require_jsx_runtime } from "./react_jsx-runtime.js";
import { a as useComposedRefs, r as createSlot } from "./dist-EKb03w6L.js";
...
__name$9(getActiveElement, "getActiveElement");
function isFrame(element) {
	return element.tagName === "IFRAME";
}
__name$9(isFrame, "isFrame");
//#endregion
...
__name$4(dispatchDiscreteCustomEvent, "dispatchDiscreteCustomEvent");
//#endregion
...
__name$3(useCallbackRef, "useCallbackRef");
//#endregion
...
var DismissableLayer = /* @__PURE__ */ import_react.forwardRef(/* @__PURE__ */ __name$2(function DismissableLayer2(props, forwardedRef) {
	...
	import_react.useEffect(() => {
		const handleUpdate = /* @__PURE__ */ __name$2(() => force({}), "handleUpdate");
...
__name$2(useDismissableLayerSurface, "useDismissableLayerSurface");
var IS_TRUE = /* @__PURE__ */ __name$2(() => true, "IS_TRUE");
function usePointerDownOutside(onPointerDownOutside, args) {
	...
	import_react.useEffect(() => {
		...
		__name$2(resetOutsideInteraction, "resetOutsideInteraction");
		function isOutsideInteractionIntercepted() {
			return Array.from(interceptedOutsideInteractionEventsRef.current.values()).some(Boolean);
		}
		__name$2(isOutsideInteractionIntercepted, "isOutsideInteractionIntercepted");
		...
		__name$2(handleInteractionCapture, "handleInteractionCapture");
		function handleInteractionBubble(event) {
			if (isPointerDownOutsideRef.current) interceptedOutsideInteractionEventsRef.current.set(event.type, false);
		}
		__name$2(handleInteractionBubble, "handleInteractionBubble");
		const handlePointerDown = /* @__PURE__ */ __name$2((event) => {
			if (event.target && !isPointerInsideReactTreeRef.current) {
				...
				__name$2(handleAndDispatchPointerDownOutsideEvent2, "handleAndDispatchPointerDownOutsideEvent");
	...
	return { onPointerDownCapture: /* @__PURE__ */ __name$2(() => isPointerInsideReactTreeRef.current = true, "onPointerDownCapture") };
}
__name$2(usePointerDownOutside, "usePointerDownOutside");
function useFocusOutside(onFocusOutside, ownerDocument = globalThis?.document) {
	const handleFocusOutside = useCallbackRef(onFocusOutside);
	const isFocusInsideReactTreeRef = import_react.useRef(false);
	import_react.useEffect(() => {
		const handleFocus = /* @__PURE__ */ __name$2((event) => {
	...
	return {
		onFocusCapture: /* @__PURE__ */ __name$2(() => isFocusInsideReactTreeRef.current = true, "onFocusCapture"),
		onBlurCapture: /* @__PURE__ */ __name$2(() => isFocusInsideReactTreeRef.current = false, "onBlurCapture")
	};
}
__name$2(useFocusOutside, "useFocusOutside");
function dispatchUpdate() {
	const event = new CustomEvent(CONTEXT_UPDATE);
	document.dispatchEvent(event);
}
__name$2(dispatchUpdate, "dispatchUpdate");
...
__name$2(handleAndDispatchCustomEvent, "handleAndDispatchCustomEvent");
//#endregion
...
//#endregion
export { useCallbackRef as a, useId as c, composeEventHandlers as d, useDismissableLayerSurface as i, useLayoutEffect2 as l, Portal as n, Primitive as o, DismissableLayer as r, useControllableState as s, Presence as t, createContextScope as u };
