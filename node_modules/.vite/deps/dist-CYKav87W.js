...
import { a as useComposedRefs } from "./dist-EKb03w6L.js";
import { n as dispatchDiscreteCustomEvent, t as Primitive } from "./dist-Dr7xkmGs.js";
...
__name$8(getActiveElement, "getActiveElement");
function isFrame(element) {
	return element.tagName === "IFRAME";
}
__name$8(isFrame, "isFrame");
//#endregion
...
function createContext2(rootComponentName, defaultContext) {
	...
	const Provider = /* @__PURE__ */ __name$7((props) => {
	...
	__name$7(useContext2, "useContext");
	return [Provider, useContext2];
}
__name$7(createContext2, "createContext");
// @__NO_SIDE_EFFECTS__
function createContextScope(scopeName, createContextScopeDeps = []) {
	...
	__name$7(createContext3, "createContext");
	const createScope = /* @__PURE__ */ __name$7(() => {
		const scopeContexts = defaultContexts.map((defaultContext) => {
			return import_react.createContext(defaultContext);
		});
		return /* @__PURE__ */ __name$7(function useScope(scope) {
...
__name$7(createContextScope, "createContextScope");
function composeContextScopes(...scopes) {
	...
	const createScope = /* @__PURE__ */ __name$7(() => {
		...
		return /* @__PURE__ */ __name$7(function useComposedScopes(overrideScopes) {
...
__name$7(composeContextScopes, "composeContextScopes");
//#endregion
...
//#endregion
export { useLayoutEffect2 as a, useCallbackRef as c, useId as i, createContextScope as l, Presence as n, DismissableLayer as o, Portal as r, useDismissableLayerSurface as s, useControllableState as t, composeEventHandlers as u };
